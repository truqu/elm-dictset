...
insert value set =
    ...
    in
        DictSet compare_ <| Dict.insert (compare_ value) value (dict set)
...
remove value set =
    let
        compare_ =
            DictSet.Internal.compare set
    in
        DictSet compare_ <| Dict.remove (compare_ value) (dict set)
...
union set1 set2 =
    ...
    in
        DictSet compare_ <| Dict.union (dict set1) (dict set2)
...
intersect set1 set2 =
    let
        compare_ =
            DictSet.Internal.compare set1
    in
        DictSet compare_ <| Dict.intersect (dict set1) (dict set2)
...
diff set1 set2 =
    let
        compare_ =
            DictSet.Internal.compare set1
    in
        DictSet compare_ <| Dict.diff (dict set1) (dict set2)
...
fromList compare list =
    ...
    in
        DictSet compare <| Dict.fromList list_
